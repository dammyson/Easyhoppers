...
import { Alert, Platform, FlatList, StyleSheet, Text, View,TouchableOpacity, AsyncStorage, Image, TextInput } from 'react-native';
    ...
    return (
      ...
      <View style={styles.container}>
        <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'center', paddingTop: 8, paddingBottom: 10, color: "#fff", fontWeight: '900', fontSize: 13, }}>
          ...
          <Text style={{ color: "#fff", fontWeight: '900', fontSize: 16, flex:1, textAlign:'center' }}>Live Update</Text>
        </View>
