                    ...
                    <View style={styles.body}>
                        ...
                        >
                            <View style={styles.headerContent}>
                                <Text style={{ color: '#FFF', margin: 15, fontWeight: '900', fontSize: 16, }}>Forgot Password  </Text>
                            ...
                            <ScrollView style={{ flex: 1, }}>
                                <View style={{ flex: 1, marginTop: 6, marginLeft: 30, marginRight: 30, paddingTop: 40 }}>
                                    ...
                                    <View style={styles.inputContainer}>
                                      ...
                                      <Text style={{ color: '#403C3B', margin: 5, fontSize: 12, fontWeight: '200' }}>OR</Text>
                                      <View style={styles.lineStyle} />
                                    </View>


                                    <Text style={{ color: '#403C3B', marginBottom: 7, marginTop: 10, fontWeight: '400', fontSize: 13, }}> Email Address </Text>
                                    <View style={styles.oneRowTextInput}>
                                        <View style={styles.textInputIconContainer}>
                                    ...
                                    <TouchableOpacity onPress={()=> Actions.changepassword({type: 'replace'})} style={styles.actionButton}>
